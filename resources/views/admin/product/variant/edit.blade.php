                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body table-responsive p-0">
                            <form id="productForm"
                                action="{{ route('admin.product.variant.update', ['productVariant' => $productVariant->variant_id]) }}"
                                                ...
                                                <div class="form-check">
                                                    <div>
                                                        <input class="form-check-input" name="type" type="radio"
                                                            id="ml" value="ml" {{$productVariant->type == "ml" ? "checked" : ""}}>
                                                        <label class="form-check-label" for="ml">ml</label>
                                                    </div>
                                                    <div>
                                                        <input class="form-check-input" name="type" type="radio"
                                                            id="gm" value="gm"  {{$productVariant->type == "gm" ? "checked" : ""}}>
                                        ...
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="size" step="0.01" class="form-control"
                                                    placeholder="400.00" value="{{$productVariant->size}}">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="price" step="0.01" class="form-control"
                                                    placeholder="400.00" value="{{$productVariant->price}}">
                                            </div>
                                        </div>
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="weight" step="0.01" class="form-control"
                                                    placeholder="400.00" value="{{$productVariant->weight}}">
                                            </div>
                                        </div>
                                    </div>
